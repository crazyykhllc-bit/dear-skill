...
时间总是偷偷抹去很多东西。你可能已经开始记不清奶奶离开那天天气怎样，却总在某个瞬间，极其怀念她喊你乳名时的语气。你那不善言辞的父亲，在微信里总是只回笨拙的“好的”。你远在老家的母亲，打来电话的第一句永远是“吃了吗”。

那些细碎的唠叨、日常的叮嘱、甚至是已经定格在过去的聊天框，不该变成手机里沉睡的数据。

亲人.skill 试图将这些温度重聚。提供亲友的原材料（微信聊天记录、语音消息、照片），加上你记忆中最鲜活的主观描述，我们将为你“拼凑”并生成一个真正像 ta 的 AI Skill——它不会懂天文地理，但它会用 ta 独有的口头禅跟你说话，用 ta 的方式关心你，记得你们一起经历过的一切。
